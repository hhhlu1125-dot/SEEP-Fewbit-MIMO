...
function [Sigma_q, Mu_q] = SEEP_detection(RxSymbol_Q, Hreal, sigma2, sym, Q_bit, Delta, iterNum)
        ...
        Sigma_q_r = M_inv + A_r * Sigma_q * A_r'; 
        Mu_q_r = A_r * Mu_q + b_r;
        ...
        for k = 1:iterNum
            ...
            % refine posterior probability of TX symbol
